...
class greLearn extends StatefulWidget {
  const greLearn({Key? key}) : super(key: key);

  @override
  _greLearnState createState() => _greLearnState();
}

class _greLearnState extends State<greLearn> {
  int _currIndex = 0;
  ...
  void initState() {
    super.initState();
    selectedWord = list1[0];
    words = list1;
    selectedList = lists[0];
    _pron = "vuh·ray·shuhs";
    _mean = "desiring or consuming great quantities.";
    _sen = "she's a voracious reader";
    _imgUrl = "https://i.ytimg.com/vi/KZys-b__5mw/maxresdefault.jpg";
  ...
  void speak() async{
    if(selectedWord!.isNotEmpty){
      ...
      await _flutterTts.speak(selectedWord!);
    }
  }
    ...
    return Scaffold(
                      ...
                      child: DropdownButton<String>(
                        ...
                        onChanged: (list) {
                          if (list == 'List 1') {
                            ...
                            words = list2;
                            _pron = "pa·ruh·doks";
                            _mean = "a statement that at first seems to be absurd or self-contradictory but which may in fact turn out to be true";
                            _sen = "the uncertainty principle leads to all sorts of paradoxes, like the particles being in two places at once";
                            _imgUrl = "https://qph.fs.quoracdn.net/main-qimg-72aea33cd0f3230f73a1e3296760f049.webp";
                          }else if (list == 'List 3') {
                            words = list3;
                             _pron = "luh·ko·nuhk";
                            _mean = "expressing much in few words";
                            _sen = "his laconic reply suggested a lack of interest in the topic";
                            _imgUrl = "https://wordinfo.info/words/images/laconic-1.jpg";
                          }else if (list == 'List 4') {
                            words = list4;
                            _pron = "pree·tekst";
                            _mean = "an excuse";
                            _sen = "The rebels had the perfect pretext for making their move.";
                            _imgUrl = "https://image.shutterstock.com/image-illustration/man-late-appointment-flat-style-260nw-468267893.jpg";
                          }else if (list == 'List 5') {
                            words = list5;
                            _pron = "lowth";
                            _mean = "to hate";
                            _sen = "If there's one thing I loathe,the coach said, it's a quitter.";
                            _imgUrl = "https://www.grammar-monster.com/easily_confused/pics/loath_or_loathe.png";
                          }else if (list == 'List 6') {
                            words = list6;
                            _pron = "o·muh·nuhs";
                            _mean = "threatening, sinister";
                            _sen = "There was an ominous silence when the jittery defendant rose in court.";
                            _imgUrl = "https://mammothmemory.net/images/user/base/English/vocab/remember-ominous-in-english-vocab.34c4e4b.jpg";
                          }else if (list == 'List 7') {
                            words = list7;
                            _pron = "uh·la·kruh·tee";
                            _mean = "briskness, lively action";
                            _sen = "She accepted the invitation with alacrityshe accepted the invitation with alacrity.";
                            _imgUrl = "https://wordinfo.info/words/images/Alacrity-color-1.jpg";
                          }else if (list == 'List 8') {
                            words = list8;
                            _pron = "tan·juh·bl";
                            _mean = "having actual form";
                            _sen = "Some people enjoy tangible gifts, while others would rather time spent with friends or a phone call.";
                            _imgUrl = "https://i.ytimg.com/vi/QkKvH2qhRWA/maxresdefault.jpg";
                          }else if (list == 'List 9') {
                            words = list9;
                            _pron = "ram·pnt";
                            _mean = "going unchecked, widespread";
                            _sen = "Cholera was rampant in the district.";
                            _imgUrl = "https://i.ytimg.com/vi/p4GvVPMvSok/movieposter.jpg";
                          }else if (list == 'List 10') {
                            words = list10;
                            _pron = "uh·gree·juhs";
                            _mean = "remarkably bad";
                            _sen = "He made the egregious mistake of getting caught cheating on a midterm exam.";
                            _imgUrl = "https://dailyvocab.com/wp-content/uploads/2013/11/EGREGIOUSS.jpg";
                          }else if (list == 'List 11') {
                            words = list11;
                            _pron = "a·floo·uhnt";
                            _mean = "rich";
                            _sen = "The affluent societies of the western world.";
                            _imgUrl = "https://www.bragitoff.com/wp-content/uploads/2015/06/affluent.jpg";
                          }else if (list == 'List 12') {
                            words = list12;
                            _pron = "duh·spae·ruhj";
                            _mean = "to discredit, belittle";
                            _sen = "He never missed an opportunity to disparage his competitors.";
                            _imgUrl = "https://dailyvocab.com/wp-content/uploads/2020/03/disparage.jpg";
                          }else if (list == 'List 13') {
                            words = list13;
                            _pron = "uhm·pla·kuh·bl";
                            _mean = "cannot be pacified, inexorable, unforgiving";
                            _sen = "He was an implacable enemy of Ted's.";
                            _imgUrl = "https://avatars.mds.yandex.net/get-zen_doc/1362956/pub_5ae36e273dceb76be76eb99a_5ae38070f03173ba38d055a9/scale_1200";
                          } else {
                            words= [];
                          }
                          setState(() {
                  ...
                  Padding(
                    ...
                    child: DropdownButton<String>(
                      ...
                      onChanged: (word) {
                        setState(() {
                          selectedWord = word;
                          _currIndex = words.indexOf(selectedWord!);
                          Details();
                        });
                      },
                    ),
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Container(
                                ...
                                child: RichText(text: TextSpan(text: '$_mean',style: TextStyle(color: Colors.teal,fontSize: 20,overflow: TextOverflow.fade)
                                ),
                                )
                            ),
                          ],
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Container(
                                width: 250,
                                padding: const EdgeInsets.only(left: 10,top: 18,bottom: 20),
                                child: RichText(text: TextSpan(text: '$_sen',style: TextStyle(color: Colors.teal,fontSize: 20,overflow: TextOverflow.fade)
                                ),
                                )
                            ),
                          ],
      ...
      bottomNavigationBar: Stack(
        ...
        children: [
          ...
          Padding(
            padding: const EdgeInsets.only(bottom: 10.0,left: 30,right: 30,top: 10),
            child:  Row(
  ...
  void nextCard() {
    setState(() {
      _currIndex = (_currIndex + 1 < words.length) ? _currIndex + 1 : 0;
      selectedWord = words[_currIndex];
      Details();
    });
  }
  ...
  void previousCard() {
    setState(() {
      _currIndex = (_currIndex -1 >= 0) ? _currIndex - 1 : words.length - 1;
      selectedWord = words[_currIndex];
      Details();
    });
  }
